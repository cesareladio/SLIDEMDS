...
const sceneDefinitions: Array<[string, ScrollChapter, number, string, TransitionType]> = [
  ...
  ['chile-scale','chile',.10,'CHILE · ESCALA','cinematic'],['chile-footprint','chile',.24,'CHILE · HUELLA','editorial'],['chile-talent','chile',.423,'CHILE · TALENTO','editorial'],['chile-capabilities','chile',.56,'CHILE · CAPACIDADES','editorial'],['chile-certifications','chile',.745,'CHILE · CERTIFICACIONES','editorial'],['chile-history','chile',.98,'CHILE · HISTORIA','editorial'],
